...
import { ArrowLeft, Calendar, User, Tag, Facebook, Twitter, Linkedin, Share2 } from 'lucide-react';
        ...
        <div className="relative h-64 md:h-96 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6">
            <div className="container mx-auto">
              ...
              <h1 className="text-white text-2xl md:text-4xl font-bold mb-2">{post.title}</h1>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
              <div className="flex items-center">
                <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden mr-4">
                  <img 
                    src={`https://ui-avatars.com/api/?name=${post.author.firstName.replace(' ', '+')}&background=0D8A9E&color=fff`}
                    alt={post.author.firstName + " "+ post.author.lastName}
                    className="w-full h-full object-cover"
                  />
                </div>
                <div>
                  <h3 className="font-bold text-lg">{post.author.firstName + " "+ post.author.lastName}</h3>
                  <p className="text-gray-600 text-sm">Medical Technology Specialist</p>
                </div>
              </div>
              <p className="mt-4 text-gray-600">
                A healthcare technology expert with over 15 years of experience in the medical equipment industry. Specializes in emerging technologies and their application in clinical settings.
              </p>
            </div>
                ...
                {relatedPosts.length > 0 ? (
                  relatedPosts.map(relatedPost => (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-sm font-medium group-hover:text-medical-600 line-clamp-2">{relatedPost.title}</h4>
